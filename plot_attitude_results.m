function figures = plot_attitude_results(resultsFile)
% Description:
%   Loads the latest simulation result and plots attitude body rates,
%   quaternion, Euler angles, rotational energy, and angular momentum norm.
%
% Arguments:
...
%   calls used by plot_attitude_results.
%
% Arguments:
%   t - Time vector.
