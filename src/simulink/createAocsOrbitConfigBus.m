...
elems(2) = busElement("epoch_tdb_jd", [1 1], "1", "TDB Julian date corresponding to the simulation epoch");
elems(3) = busElement("mu_m3_s2", [1 1], "m^3/s^2", "Central-body gravitational parameter");
elems(4) = busElement("central_body_radius_m", [1 1], "m", "Central-body reference radius");
elems(5) = busElement("semi_major_axis_m", [1 1], "m", "Initial Keplerian semi-major axis");
elems(6) = busElement("eccentricity", [1 1], "1", "Initial Keplerian eccentricity");
elems(7) = busElement("inclination_rad", [1 1], "rad", "Initial Keplerian inclination");
