...
elems(4) = busElement("F_aero_B_N", [3 1], "N", "Free-molecular aerodynamic force expressed in body axes");
elems(5) = busElement("F_aero_I_N", [3 1], "N", "Free-molecular aerodynamic force expressed in ICRF axes");
elems(6) = busElement("a_aero_I_m_s2", [3 1], "m/s^2", "Aerodynamic acceleration fed back to the orbit propagator");
elems(7) = busElement("q_dyn_N_m2", 1, "N/m^2", "Dynamic pressure based on DTM2020 total density");
elems(8) = busElement("v_rel_norm_m_s", 1, "m/s", "Spacecraft-atmosphere relative speed");
