function [sun_B_unit, sun_I_unit, r_sun_I_m, sun_distance_m, solar_flux_W_m2] = computeSunProducts(epoch_utc, t_s, solar_constant_W_m2, r_I_m, DCM_be)
% Description:
%   Computes Sun products used by the Orbit & Environment subsystem.
%
% Arguments:
...
%   sun_distance_m - Approximate spacecraft-to-Sun distance [m].
...
[r_sun_I_m, ~, ~] = sunPositionLowPrecision(epoch_utc, t_s, solar_constant_W_m2);
